package com.brine.haileader.googletaskautosync.fragment;
...
import com.brine.haileader.googletaskautosync.activity.AddTaskActivity;
import com.brine.haileader.googletaskautosync.activity.MainActivity;
import com.brine.haileader.googletaskautosync.adapter.TaskArrayAdapter;
import com.brine.haileader.googletaskautosync.api.GoogleTaskApi;
import com.brine.haileader.googletaskautosync.api.GoogleTaskApiService;
...
import com.brine.haileader.googletaskautosync.sync.TaskSyncContentProvider;
import com.brine.haileader.googletaskautosync.utils.PrefsUtil;
...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mDb = new TaskDb(getContext());
        mDb.open();

        mList = (ListView) view.findViewById(R.id.task_list);
        final View relLayoutButton = (View) view.findViewById(R.id.button);
    ...
    public void onResume() {
        ...
        mGoogleAccountName = PrefsUtil.retrieveGoogleTasksUser(getContext());
    ...
    private void updateUI() {
        TaskArrayAdapter adapter = new TaskArrayAdapter(getContext(), R.layout.task_list_row, mTasks, mDb);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        if (requestCode == REQUEST_CODE_PICK_ACCOUNT) {
            ...
            if (resultCode == getActivity().RESULT_OK) {
                ...
                PrefsUtil.saveGoogleTasksUser(getContext(), mGoogleAccountName);
                ...
                Toast.makeText(getContext(), "You must choose a Google account", Toast.LENGTH_SHORT).show();
            }
...
//		    		new AddGoogleTaskTask(mTokenText, task).execute();
        ...
        protected String fetchToken() throws IOException {
            try {
                return GoogleAuthUtil.getToken(getContext(), mEmailText, mScope);
